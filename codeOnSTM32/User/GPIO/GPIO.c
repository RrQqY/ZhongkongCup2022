...
//	RCC_APB2PeriphClockCmd(TRACK_GPIO_CLK, ENABLE);
	...
	RCC_APB2PeriphClockCmd(GRABTHREE1_GPIO_CLK, ENABLE);
	RCC_APB2PeriphClockCmd(GRABTHREE2_GPIO_CLK, ENABLE);
	RCC_APB2PeriphClockCmd(GRABTHREE3_GPIO_CLK, ENABLE);
...
//	GPIO_Init(TRACK_GPIO_PORT, &GPIO_InitStruct);
	...
	GPIO_InitStruct.GPIO_Pin = GRABTHREE1_GPIO_PIN;
	GPIO_Init(GRABTHREE1_GPIO_PORT, &GPIO_InitStruct);
	GPIO_InitStruct.GPIO_Pin = GRABTHREE2_GPIO_PIN;
	GPIO_Init(GRABTHREE2_GPIO_PORT, &GPIO_InitStruct);
	GPIO_InitStruct.GPIO_Pin = GRABTHREE3_GPIO_PIN;
	GPIO_Init(GRABTHREE3_GPIO_PORT, &GPIO_InitStruct);
