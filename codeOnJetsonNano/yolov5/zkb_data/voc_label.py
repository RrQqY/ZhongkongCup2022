...
def convert_annotation(image_id):
    in_file = open('C:/Users/ASUS/Desktop/yolov5/zkb_data/Annotations/%s.xml' % (image_id), encoding='UTF-8')
    out_file = open('C:/Users/ASUS/Desktop/yolov5/zkb_data/labels/%s.txt' % (image_id), 'w')
